...
const App = {
  ...
  CHANGELOG: {
    ...
    'v33': [
      '🎬 影音记录填表时即可一并记录「摘抄」和「笔记」，保存后自动归入该影音的摘抄/笔记列表',
      '🎬 影音记录全部内容均可修改：卡片与详情页新增「编辑」按钮，可回改任意字段并同步摘抄/笔记',
    ...
    'v39': [
      '📡 修复抓取时间显示与结果不一致：当所有 RSS 源均失败时，不再更新「上次抓取」时间，避免显示「刚刚」但列表无新内容；当抓取成功但去重后无新增时，提示「暂无新增」而不是「抓取完成」',
      '📡 统一抓取周期文案：手动抓取弹窗和模块顶部文案统一为「1 小时」'
    ]
  },
